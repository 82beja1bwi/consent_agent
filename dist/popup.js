...
/* harmony export */ });
/* harmony import */ var _domain_models_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domain/models/header.js */ "./src/background/domain/models/header.js");
/* harmony import */ var _domain_models_contract_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domain/models/contract.js */ "./src/background/domain/models/contract.js");
/* harmony import */ var _utils_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/util.js */ "./src/utils/util.js");
/* harmony import */ var _init_dependencies_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./init_dependencies.js */ "./src/background/init_dependencies.js");
/* harmony import */ var _domain_models_proposal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domain/models/proposal.js */ "./src/background/domain/models/proposal.js");
...
function handleMessage(request, sender, sendResponse) {
  ...
  switch (request.action) {
    case MessageActions.PROPOSAL_ACCEPTED:
      ...
      _init_dependencies_js__WEBPACK_IMPORTED_MODULE_3__.interceptor.handleAcceptedProposal(hostname, request.proposal).then(function (header) {
        ...
        var url = _ref.url,
          headerString = _ref.headerString;
        fetch(url, {
          headers: {
            ADPC: headerString
          }
    ...
    case MessageActions.GET_DATA:
      // no async/await because responses would not be sent to sender
      _init_dependencies_js__WEBPACK_IMPORTED_MODULE_3__.interceptor.handleGetData(hostname).then(function (response) {
...
browser.webRequest.onBeforeSendHeaders.addListener( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(details) {
    var _URL, hostname, header;
 ...
 */
// eslint-disable-next-line no-undef
browser.webRequest.onHeadersReceived.addListener( /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(details) {
    var responseHeaders, headerString, _URL2, header, hostName, result, headers, url;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          headerString = responseHeaders.find(function (header) {
            ...
            if (tabs.length > 0) {
              for (var i = 0; i < tabs.length; i++) {
                ...
                browser.tabs.reload(tabId).then(function () {
                  return console.log('Refreshed Page');
                })["catch"](function (error) {
                  return console.error('Error on page refresh: ', error);
                });
              }
            }
          })["catch"](function (error) {
...
/***/ "./src/background/badge_text_manager.js":
/*!**********************************************!*\
  !*** ./src/background/badge_text_manager.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BadgeTextManager)
/* harmony export */ });
/* harmony import */ var _storage_proposalRepository_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storage/proposalRepository.js */ "./src/background/storage/proposalRepository.js");
...
var _fromHostnameToBadgeText = /*#__PURE__*/new WeakMap();
...
function BadgeTextManager(proposalRepository) {
  ...
  _classPrivateFieldInitSpec(this, _handleProposalsUpdates, function () {
    _this.proposalRepository.proposals$.subscribe({
      next: function () {
        var _next2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(proposals) {
          var hostname;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
  ...
  _classPrivateFieldInitSpec(this, _handleNewSiteInTab, function () {
    /**
     * Inside a tab a new site is loaded or current one is updated
     * CASE: user opens new tab, then opens gmail
     */
    // eslint-disable-next-line no-undef
    browser.tabs.onUpdated.addListener( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tabId, changeInfo, tabInfo) {
        var hostname;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _classPrivateFieldGet(_fromHostnameToBadgeText, _this).call(_this, hostname);
            case 3:
            case "end":
              return _context2.stop();
          }
  ...
  _classPrivateFieldInitSpec(this, _handleAnotherTabSelected, function () {
     ...
     */
    // eslint-disable-next-line no-undef
    browser.tabs.onActivated.addListener( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(activeInfo) {
        var hostname;
  ...
  _classPrivateFieldInitSpec(this, _fromHostnameToBadgeText, /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(hostname) {
      var proposal;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _classPrivateFieldGet(_getProposal, _this).call(_this, hostname);
          case 2:
            proposal = _context4.sent;
            _classPrivateFieldGet(_setBadgeText, _this).call(_this, proposal);
          case 4:
          case "end":
  ...
  _classPrivateFieldInitSpec(this, _getProposal, /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(hostName) {
  ...
  _classPrivateFieldInitSpec(this, _setBadgeText, function (proposal) {
    var text = proposal && !proposal.userHasAccepted ? '1' : '';
    // eslint-disable-next-line no-undef
 ...
 */
var _preferencesDataToFunction = /*#__PURE__*/new WeakMap();
var _combineBools = /*#__PURE__*/new WeakMap();
var _calcContractValue = /*#__PURE__*/new WeakMap();
var Calculator = /*#__PURE__*/function () {
  function Calculator() {
     ...
     */
    _classPrivateFieldInitSpec(this, _preferencesDataToFunction, function (scoredPreferences, isUserPreferences) {
      var _scoredPreferences$co;
      var is3CNegotiation = (_scoredPreferences$co = scoredPreferences.cost) === null || _scoredPreferences$co === void 0 ? void 0 : _scoredPreferences$co.relevance;
     ...
     */
    _classPrivateFieldInitSpec(this, _combineBools, function (limit,
    // initally e.g. 3
    bools,
    // initally an empty array
    resultingListOfBoolsLists) {
      if (limit === 0) {
        // console.log(bools)// this i want to add to a list of lists
        resultingListOfBoolsLists.push(_toConsumableArray(bools));
        return;
      }
      ...
      for (var _i = 0, _arr = [false, true]; _i < _arr.length; _i++) {
        var bool = _arr[_i];
        bools.push(bool);
        _classPrivateFieldGet(_combineBools, _this).call(_this, limit, bools, resultingListOfBoolsLists);
        bools.pop(bool);
      }
    });
    /**
     ...
     * @returns
     */
    _classPrivateFieldInitSpec(this, _calcContractValue, function (usersScoringFunction, sitesScoringFunction, consentCombination, usersContentPreference, sitesContentPreference, usersCostPreference, sitesCostPreference) {
      return usersScoringFunction(consentCombination, usersContentPreference, usersCostPreference) * sitesScoringFunction(consentCombination, sitesContentPreference, sitesCostPreference);
    });
  }
  return _createClass(Calculator, [{
    ...
    value: function calcNashContracts(usersScoredPreferences, sitesScoredPreferences, usersScoringFunction, sitesScoringFunction, noOfBestContracts) {
      ...
      var consentCombinations = [];
      var limit = Object.keys(sitesScoredPreferences.consent.resolutions).length;
      _classPrivateFieldGet(_combineBools, this).call(this, limit, [], consentCombinations);
...
/***/ "./src/background/domain/interceptor.js":
/*!**********************************************!*\
  !*** ./src/background/domain/interceptor.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _models_contract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/contract.js */ "./src/background/domain/models/contract.js");
...
/* harmony import */ var _models_proposal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/proposal.js */ "./src/background/domain/models/proposal.js");
/* harmony import */ var _negotiator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./negotiator.js */ "./src/background/domain/negotiator.js");
/* harmony import */ var _storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../storage/contracts_repository.js */ "./src/background/storage/contracts_repository.js");
/* harmony import */ var _preference_manager_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./preference_manager.js */ "./src/background/domain/preference_manager.js");
/* harmony import */ var _storage_proposalRepository_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../storage/proposalRepository.js */ "./src/background/storage/proposalRepository.js");
/* harmony import */ var _models_consent_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/consent.js */ "./src/background/domain/models/consent.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
var Interceptor = /*#__PURE__*/function () {
   ...
   */
  function Interceptor(contractRepository, proposalRepository, negotiator, preferenceManager) {
...
var Consent = /*#__PURE__*/function () {
  ...
  return _createClass(Consent, [{
    ...
    key: "setMarketing",
    value: function setMarketing(bool) {
      this.marketing = bool;
      return this; // Return 'this' for chaining
    }
  }, {
    key: "setPersonalizedContent",
    value: function setPersonalizedContent(bool) {
      this.personalizedContent = bool;
      return this; // Return 'this' for chaining
    }
  }, {
    key: "setPersonalizedAds",
    value: function setPersonalizedAds(bool) {
      this.personalizedAds = bool;
      return this; // Return 'this' for chaining
    }
  }, {
    key: "setExternalContent",
    value: function setExternalContent(bool) {
      this.externalContent = bool;
      return this; // Return 'this' for chaining
    }
  }, {
    key: "setIdentification",
    value: function setIdentification(bool) {
      this.identification = bool;
      return this; // Return 'this' for chaining
    }
  }, {
    key: "isRejectAll",
    value: function isRejectAll() {
    ...
    value: function fromObject(object) {
      var consent = new Consent();
      consent.setAnalytics(object.analytics || false).setExternalContent(object.externalContent || false).setIdentification(object.identification || false).setMarketing(object.marketing || false).setPersonalizedAds(object.personalizedAds || false).setPersonalizedContent(object.personalizedContent || false);
      return consent;
    }
  }]);
}();
...
var Contract = /*#__PURE__*/function () {
  ...
  return _createClass(Contract, [{
    ...
    key: "setConsent",
    value: function setConsent(value) {
      this.consent = value;
      return this;
    }
  }, {
...
/* harmony export */ });
/* harmony import */ var _scored_preferences_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scored_preferences.js */ "./src/background/domain/models/scored_preferences.js");
  ...
  return _createClass(Header, [{
    ...
    value: function fromString(header) {
      ...
      if (matches[1]) {
        ...
        matches[1] = Array.isArray(data) ? [_scored_preferences_js__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON(data[0]), _scored_preferences_js__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON(data[1])] : [_scored_preferences_js__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON(data)];
      }
      if (matches[2]) {
        matches[2] = _consent_js__WEBPACK_IMPORTED_MODULE_1__["default"].fromString(matches[2]);
      }
      return new Header().setStatus(matches[0]).setPreferences(matches[1]).setConsent(matches[2]).setCost(matches[3] ? parseFloat(matches[3]) : 0).setContent(matches[4] ? parseFloat(matches[4]) : 0);
    }
  }]);
}();
...
/***/ "./src/background/domain/models/proposal.js":
/*!**************************************************!*\
  !*** ./src/background/domain/models/proposal.js ***!
  \**************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Proposal)
/* harmony export */ });
/* harmony import */ var _contract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./contract.js */ "./src/background/domain/models/contract.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var Proposal = /*#__PURE__*/function (_Contract) {
  ...
  _inherits(Proposal, _Contract);
  return _createClass(Proposal, [{
    key: "setUserHasAccepted",
    value: function setUserHasAccepted(bool) {
...
/***/ "./src/background/domain/models/scored_preferences.js":
/*!************************************************************!*\
  !*** ./src/background/domain/models/scored_preferences.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var Issue = /*#__PURE__*/function () {
   ...
   */
  function Issue(relevance, resolutions) {
    _classCallCheck(this, Issue);
    this.relevance = relevance;
    this.resolutions = resolutions;
  }
  return _createClass(Issue, [{
    key: "setRelevance",
    value: function setRelevance(relevance) {
      this.relevance = relevance;
      return this;
    }
  }, {
...
var ScoredPreferences = /*#__PURE__*/function () {
   ...
   * @param {Issue} content
   */
  function ScoredPreferences(cost, consent, content) {
  ...
  return _createClass(ScoredPreferences, [{
    ...
    value: function fromJSON(json) {
      var scoredPreferences = new ScoredPreferences(new Issue(), new Issue(), new Issue());
      for (var key in json) {
        var _json$key, _json$key2;
        if (!Object.keys(scoredPreferences).includes(key)) {
          throw new Error("Unknown issue '".concat(key, "'."));
        }
        scoredPreferences["".concat(key)].setRelevance((_json$key = json[key]) === null || _json$key === void 0 ? void 0 : _json$key.relevance).setResolutions((_json$key2 = json[key]) === null || _json$key2 === void 0 ? void 0 : _json$key2.resolutions);
      }
      var totalRelevance = Object.values(scoredPreferences).reduce(function (total, issue) {
...
/* harmony import */ var _preference_manager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./preference_manager.js */ "./src/background/domain/preference_manager.js");
...
var Negotiator = /*#__PURE__*/function () {
  ...
  return _createClass(Negotiator, [{
    ...
    value: function prepareInitialOffer() {
      var consent = new _models_consent_js__WEBPACK_IMPORTED_MODULE_3__["default"](); // empty consent equals reject all
      return new _models_header_js__WEBPACK_IMPORTED_MODULE_4__["default"]().setStatus(_models_header_js__WEBPACK_IMPORTED_MODULE_4__.NegotiationStatus.EXCHANGE).setConsent(consent);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PreferenceManager)
/* harmony export */ });
/* harmony import */ var _storage_preferences_repository_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../storage/preferences_repository.js */ "./src/background/storage/preferences_repository.js");
/* harmony import */ var _models_header_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/header.js */ "./src/background/domain/models/header.js");
...
var _siteHasDifferentConsentResolutions = /*#__PURE__*/new WeakMap();
var _siteHasDifferentContentResolutions = /*#__PURE__*/new WeakMap();
var _adaptUsersConsentResolutions = /*#__PURE__*/new WeakMap();
var _adaptUsersContentResolutions = /*#__PURE__*/new WeakMap();
var _usersContentFunction = /*#__PURE__*/new WeakMap();
var PreferenceManager = /*#__PURE__*/function () {
  /**
   *
   * @param {PreferenceRepository} preferenceRepository
   */
  function PreferenceManager(preferenceRepository) {
    var _this = this;
    _classCallCheck(this, PreferenceManager);
    _classPrivateFieldInitSpec(this, _siteHasDifferentConsentResolutions, function (requiredConsentKeys, actualConsentKeys) {
      return requiredConsentKeys.length < actualConsentKeys.length;
    });
    _classPrivateFieldInitSpec(this, _siteHasDifferentContentResolutions, function (sitesScoredPreferences, scoredPreferences) {
      var _scoredPreferences$co;
      return sitesScoredPreferences.content && !((_scoredPreferences$co = scoredPreferences.content) !== null && _scoredPreferences$co !== void 0 && _scoredPreferences$co.resolutions);
    });
    _classPrivateFieldInitSpec(this, _adaptUsersConsentResolutions, function (requiredConsentKeys, usersResolutions) {
      var pointsToBeSplit = 0;
      Object.keys(usersResolutions).forEach(function (key) {
      ...
      if (pointsToBeSplit > 0) {
        var l = requiredConsentKeys.length;
        var points = pointsToBeSplit / l;
        for (var key in usersResolutions) {
          var value = usersResolutions[key];
          usersResolutions[key] = Math.round((value + points) * 100) / 100;
        }
      }
    });
    _classPrivateFieldInitSpec(this, _adaptUsersContentResolutions, function (sitesContentResolutions, scoredPreferences) {
      scoredPreferences.consent.relevance = 0.4;
      var content = new _models_scored_preferences_js__WEBPACK_IMPORTED_MODULE_2__.Issue().setRelevance(0.6).setResolutions({});
      for (var key in sitesContentResolutions) {
        content.resolutions[key] = _classPrivateFieldGet(_usersContentFunction, _this).call(_this, key);
      }
      scoredPreferences.setContent(content);
    });
    _classPrivateFieldInitSpec(this, _usersContentFunction, function (xContenPercentage) {
      // imitate a preference function for content options
      var points = new Map([[100, 1], [80, 0.9], [70, 0.7], [50, 0.5], [30, 0.1], [0, 0]]);
...
/***/ "./src/background/init_dependencies.js":
/*!*********************************************!*\
  !*** ./src/background/init_dependencies.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   badgeTextManager: () => (/* binding */ badgeTextManager),
/* harmony export */   contractRepository: () => (/* binding */ contractRepository),
/* harmony export */   interceptor: () => (/* binding */ interceptor),
/* harmony export */   proposalRepository: () => (/* binding */ proposalRepository)
/* harmony export */ });
/* harmony import */ var _badge_text_manager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./badge_text_manager.js */ "./src/background/badge_text_manager.js");
/* harmony import */ var _domain_calculator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domain/calculator.js */ "./src/background/domain/calculator.js");
/* harmony import */ var _domain_interceptor_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domain/interceptor.js */ "./src/background/domain/interceptor.js");
...
/* harmony import */ var _domain_preference_manager_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domain/preference_manager.js */ "./src/background/domain/preference_manager.js");
/* harmony import */ var _storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./storage/contracts_repository.js */ "./src/background/storage/contracts_repository.js");
...
/* harmony import */ var _storage_proposalRepository_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./storage/proposalRepository.js */ "./src/background/storage/proposalRepository.js");
...
// Repositories
var proposalRepository = new _storage_proposalRepository_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
var contractRepository = new _storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
var preferenceRepository = new _storage_preferences_repository_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

// Domain
var calculator = new _domain_calculator_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
var preferenceManager = new _domain_preference_manager_js__WEBPACK_IMPORTED_MODULE_4__["default"](preferenceRepository);
var negotiator = new _domain_negotiator_js__WEBPACK_IMPORTED_MODULE_3__["default"](calculator, preferenceManager);
var interceptor = new _domain_interceptor_js__WEBPACK_IMPORTED_MODULE_2__["default"](contractRepository, proposalRepository, negotiator, preferenceManager);
var badgeTextManager = new _badge_text_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"](proposalRepository);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PreferenceRepository)
/* harmony export */ });
...
/***/ "./src/background/storage/proposalRepository.js":
/*!******************************************************!*\
  !*** ./src/background/storage/proposalRepository.js ***!
  \******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ProposalRepository)
/* harmony export */ });
/* harmony import */ var _domain_models_proposal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../domain/models/proposal.js */ "./src/background/domain/models/proposal.js");
...
var ProposalRepository = /*#__PURE__*/function () {
  function ProposalRepository() {
    var _this = this;
    _classCallCheck(this, ProposalRepository);
    _classPrivateFieldInitSpec(this, _init, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            browser.storage.local.onChanged.addListener(function (changes, area) {
              ...
              if (changedItems.includes('proposals')) {
                ...
                _this.proposals$.next(changes.proposals.newValue);
              }
            });
          case 1:
          case "end":
    ...
    this.proposals$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__.BehaviorSubject(this.proposals);
    _classPrivateFieldGet(_init, this).call(this);
  }
  return _createClass(ProposalRepository, [{
    key: "getProposal",
    value: (
    /**
     *
     ...
     */
    function () {
      var _getProposal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(hostName) {
        var storageData, proposals;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return browser.storage.local.get('proposals');
            case 2:
              storageData = _context2.sent;
              proposals = storageData.proposals || {}; // If proposals object doesn't exist, initialize it as an empty object
              return _context2.abrupt("return", _domain_models_proposal_js__WEBPACK_IMPORTED_MODULE_0__["default"].fromData(proposals[hostName]) || null);
            case 5:
            case "end":
              return _context2.stop();
          }
    ...
    key: "deleteProposal",
    value: function () {
      var _deleteProposal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(hostName) {
        var storageData, proposals;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
    ...
    key: "setProposal",
    value: (function () {
      var _setProposal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(proposal) {
        var storageData, proposals;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
      ...
      function setProposal(_x3) {
        return _setProposal.apply(this, arguments);
      }
      return setProposal;
    }())
  }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _background_background_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../background/background.js */ "./src/background/background.js");
/* harmony import */ var _background_domain_models_proposal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../background/domain/models/proposal.js */ "./src/background/domain/models/proposal.js");
/* harmony import */ var _background_domain_models_contract_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../background/domain/models/contract.js */ "./src/background/domain/models/contract.js");
/* harmony import */ var _utils_util_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/util.js */ "./src/utils/util.js");
var _response$proposals;
...
var hostname = await (0,_utils_util_js__WEBPACK_IMPORTED_MODULE_3__.getHostname)();
var response = await browser.runtime.sendMessage({
  action: _background_background_js__WEBPACK_IMPORTED_MODULE_0__.MessageActions.GET_DATA,
  hostname: hostname
});

// console.log(response)

var proposals = (_response$proposals = response.proposals) === null || _response$proposals === void 0 ? void 0 : _response$proposals.map(function (proposal) {
  return _background_domain_models_proposal_js__WEBPACK_IMPORTED_MODULE_1__["default"].fromData(proposal);
});
var contract = _background_domain_models_contract_js__WEBPACK_IMPORTED_MODULE_2__["default"].fromData(response.contract);
var costResolutions = response.costResolutions;
...
if (proposals) {
  ...
  var proposalsContainer = document.getElementById('contractContainer');
  proposals.forEach(function (proposal) {
    var btnCallback = function btnCallback() {
      console.log('POPUP: slected proposal: ', proposal, ' ', hostname);
      browser.runtime.sendMessage({
        action: _background_background_js__WEBPACK_IMPORTED_MODULE_0__.MessageActions.PROPOSAL_ACCEPTED,
        proposal: proposal,
        hostname: hostname
      });
      window.close();
    };
    var proposalElement = createThreeCHtml(proposal, btnCallback);
    proposalsContainer.appendChild(proposalElement);
  });
} else if (costResolutions && (!contract.cost || contract.cost === 0)
// &&  contract.consent.isRejectAll()
) {
  document.getElementById('description').textContent = 'CURRENT CONTRACT';
  var parent = document.getElementById('contractContainer');
  var contractElement = createThreeCHtml(contract, null);
  parent.append(contractElement);
  populateCostPreferenceSelection(costResolutions);
} else {
  document.getElementById('description').textContent = 'CURRENT CONTRACT';
  var _parent = document.getElementById('contractContainer');
  var _contractElement = createThreeCHtml(contract, null);
  _parent.append(_contractElement);
}
function createThreeCHtml(proposalOrContract, btnCallback) {
  ...
  var threeCs = ['Cost', 'Consent', 'Content'];
  for (var _i = 0, _threeCs = threeCs; _i < _threeCs.length; _i++) {
    var c = _threeCs[_i];
    ...
    var text = '';
    if (c === 'Cost') {
      var _proposalOrContract$c;
      text = (_proposalOrContract$c = proposalOrContract.cost) !== null && _proposalOrContract$c !== void 0 ? _proposalOrContract$c : 0;
    } else if (c === 'Consent') {
      var consentString = proposalOrContract.consent.isRejectAll() ? 'rejected' : proposalOrContract.consent.toString();
      text = consentString;
    } else {
      var _proposalOrContract$c2;
      text = (_proposalOrContract$c2 = proposalOrContract.content) !== null && _proposalOrContract$c2 !== void 0 ? _proposalOrContract$c2 : 100;
    }
  ...
  if (proposalOrContract.score) {
    ...
    _label.textContent = 'Score'; // Assign text content to label
    var _resolution = document.createElement('td');
    _resolution.textContent = proposalOrContract.score; // Assign text content to resolution

    _row.appendChild(_label);
    _row.appendChild(_resolution);
...
function populateCostPreferenceSelection(costResolutions) {
  var preferencesParent = document.getElementById('preferencesParent');
  ...
  var attractivenessHeader = document.createElement('th');
  ...
  costResolutions.forEach(function (resolution, i) {
    var newRow = document.createElement('tr');
    var priceCell = document.createElement('td');
    priceCell.textContent = resolution;
    newRow.appendChild(priceCell);
    var attractivenessCell = document.createElement('td');
    var container = document.createElement('div');
    container.classList.add('grade-slider-container');
    var hintTextLowest = document.createElement('span');
    ...
    var hintTextHighest = document.createElement('span');
  ...
  sendButton.addEventListener('click', function () {
    ...
    browser.runtime.sendMessage({
      action: _background_background_js__WEBPACK_IMPORTED_MODULE_0__.MessageActions.COST_PREFERENCES_RECEIVED,
...
function _getHostname() {
  _getHostname = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var url;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 2:
          url = _context.sent;
          return _context.abrupt("return", url.hostname);
        case 4:
        case "end":
          return _context.stop();
      }
...
function _getURL() {
  _getURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
