...
var Consent = /*#__PURE__*/function () {
  function Consent(rejectAll, acceptAll, analytics, marketing, personalizedContent, personalizedAds, externalContent, identification) {
  ...
  return _createClass(Consent, [{
    ...
    value: function fromString(string) {
      ...
      return new Consent(consent.rejectAll, consent.acceptAll, consent.analytics, consent.marketing, consent.personalizedContent, consent.personalizedAds, consent.externalContent, consent.identification);
    }
  }]);
}();
...
/**
     ...
     */
function Contract(baseURL, consent, cost, content) {
...
var ScoredConsentPreferences = /*#__PURE__*/function () {
  /**
     ...
     */
  function ScoredConsentPreferences(rejectAll, acceptAll, analytics, marketing, personalizedContent, personalizedAds, externalContent, identification) {
  ...
  return _createClass(ScoredConsentPreferences, null, [{
    ...
    value: function fromBase64EncodedJSON(json) {
      ...
      return new ScoredConsentPreferences(data.rejectAll, data.acceptAll, data.analytics, data.marketing, data.personalizedContent, data.personalizedAds, data.externalContent, data.identification);
    }
  }]);
}();
...
var ScoredPreferences = /*#__PURE__*/function () {
  ...
  return _createClass(ScoredPreferences, [{
    ...
    value: function fromBase64EncodedJSON(json) {
      var data = JSON.parse(atob(json));
      return new ScoredPreferences(data.cost, data.consent, data.content);
    }
  }]);
}();
...
/* harmony export */   setContract: () => (/* binding */ setContract)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _domain_models_contract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domain/models/contract.js */ "./src/background/domain/models/contract.js");
/* harmony import */ var _domain_models_consent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domain/models/consent.js */ "./src/background/domain/models/consent.js");
/* harmony import */ var _domain_models_header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domain/models/header.js */ "./src/background/domain/models/header.js");
/* harmony import */ var _storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storage/contracts_repository.js */ "./src/background/storage/contracts_repository.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function _getDomainURL() {
  _getDomainURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var tabs, currentTab, currentUrl, domainURL;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          domainURL = currentUrl.origin;
          return _context2.abrupt("return", domainURL);
        case 7:
        case "end":
...
browser.webRequest.onBeforeSendHeaders.addListener( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(details) {
    var domainURL, contract, contractExists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return getDomainURL();
        case 3:
          domainURL = _context.sent;
          console.log('Domain URL:', domainURL);
          contract = (0,_storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_3__.getContract)(domainURL);
          ...
          if (!contractExists) {
            ...
            (0,_storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_3__.setContract)(domainURL, new _domain_models_contract_js__WEBPACK_IMPORTED_MODULE_0__["default"](domainURL, new _domain_models_consent_js__WEBPACK_IMPORTED_MODULE_1__["default"](false, false, false, false, false, false), 0, 100));
...
browser.webRequest.onHeadersReceived.addListener(function (details) {
  ...
  if (details.statusCode === 200) {
    ...
    if (header) {
      var parsedHeader = _domain_models_header_js__WEBPACK_IMPORTED_MODULE_2__["default"].fromString(header.value);
      console.log('Parsed Header ', parsedHeader);
      switch (parsedHeader.status) {
        case _domain_models_header_js__WEBPACK_IMPORTED_MODULE_2__.NegotiationStatus.EXCHANGE:
          // calculate first offer
          break;
        case _domain_models_header_js__WEBPACK_IMPORTED_MODULE_2__.NegotiationStatus.NEGOTIATION:
          // isAttractive?
          //   propose to user
          // else
          //   calculate counter offer similarly to first offer
          break;
        case _domain_models_header_js__WEBPACK_IMPORTED_MODULE_2__.NegotiationStatus.ACCEPTED:
