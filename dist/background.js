...
var Contract = /*#__PURE__*/_createClass(function Contract(baseURL, consent, cost, content) {
...
function _getBaseURL() {
  _getBaseURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var tabs, currentTab, currentUrl, baseURL;
...
browser.webRequest.onBeforeSendHeaders.addListener( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(details) {
    var baseURL, contract, contractExists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          contract = (0,_storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_1__.getContract)(baseURL);
          contractExists = contract == null ? false : true;
          if (!contractExists) {
            console.log("No contract found for base URL:", baseURL);
            //TODO: Praeferenzen laden
            //
            //Contract is initiated
            (0,_storage_contracts_repository_js__WEBPACK_IMPORTED_MODULE_1__.setContract)(baseURL, new _domain_models_contract_js__WEBPACK_IMPORTED_MODULE_0__["default"](baseURL, new _domain_models_contract_js__WEBPACK_IMPORTED_MODULE_0__["default"](false, false, false, false, false, false), 0, 100));
...
browser.webRequest.onHeadersReceived.addListener(function (details) {
  ...
  if (details.statusCode === 200) {
    ...
    var header = responseHeaders.find(function (header) {
      return header.name.toLowerCase() === 'x-custom';
    });
    if (header) {
      ...
      var url = new URL(details.url, details.originUrl);
