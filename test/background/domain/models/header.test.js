  ...
  describe('toString', () => {
    test('should convert the instance to the String header value', () => {
      const instance = new Header('exchange',
        ...
        new ScoredConsentPreferences(10, 10, 10, 10, 10, 5),
        {
          2.99: 20,
          5.49: 10,
          7.19: 5
        }),
        new Consent(true, true, true, true, true, true),
        2,
        90
      )

      expect(instance.toString()).toBe(
        'status=exchange preferences= cost=2 consent=analytics marketing personalizedContent personalizedAds externalContent identification content=90'
      )
    })
  ...
  describe('fromString', () => {
    ...
    test('IF only status & consent provided, THEN create header with status & consent only', () => {
      ...
      expect(actual).toEqual(
        new Header(
          'exchange',
          null, new Consent(false, true, true, false, false, false),
          null, null))
    })
