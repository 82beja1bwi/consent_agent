...
describe('ScoredConsentPreferences', () => {
    describe('fromJSON', () => {
        it('should create an instance of ScoredConsentPreferences from JSON data', () => {
            // Sample JSON data representing preferences
            const jsonData = '{"rejectAll":false,"acceptAll":true,"analytics":true,"marketing":false,"personalizedContent":true,"personalizedAds":false,"externalContent":true,"identification":true}';

            // Call the fromJSON method to create an instance from JSON data
            const preferences = ScoredConsentPreferences.fromJSON(jsonData);
